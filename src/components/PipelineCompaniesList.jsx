...
export default function PipelineCompaniesList({ rawData, onSelectCompany }) {
  ...
  const getStatusBadge = (company) => {
    return <span className="status-badge prospect">Pipeline</span>;
  };
  ...
  return (
    <div className="companies-list">
      <div className="list-header">
        <div className="list-stats">
          <div className="stat-item">
            ...
            <span className="stat-label">Pipeline Companies</span>
          </div>
        </div>
      </div>
      ...
      {filteredCompanies.length === 0 && (
        <div className="empty-state">No pipeline companies found</div>
      )}
    </div>
  );
}
